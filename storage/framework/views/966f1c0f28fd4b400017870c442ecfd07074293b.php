                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="<?php echo e(route('admin.product.store')); ?>" method="POST">
<?php echo csrf_field(); ?>
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                          <label for="projectinput1">duscription</label>
                                                            <input type="text" value="" id="duscription"
                                                                   class="form-control"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <label for="projectinput1">sale_price</label>
                                                            <input type="number" value="" id="sale_price"
                                                                   class="form-control"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\progects\laravel\E-commerce-Website-Watches\resources\views/admin/product/create.blade.php ENDPATH**/ ?>