 ...
 <nav
               ...
               <?php echo e(Auth::guard('admin')->user()->name); ?>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('asset/admin/images/portrait/small/avatar-s-19.png')); ?>"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="<?php echo e(asset('asset/admin/images/portrait/small/avatar-s-2.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="<?php echo e(asset('asset/admin/images/portrait/small/avatar-s-3.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="<?php echo e(asset('asset/admin/images/portrait/small/avatar-s-6.png')); ?>" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
  ...
  <!--End  Header --><?php /**PATH E:\progects\laravel\E-commerce-Website-Watches\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>