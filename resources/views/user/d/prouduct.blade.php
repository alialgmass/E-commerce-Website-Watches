                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5">
                        <div class="header-img">
                            <img src="{{asset('asset/img/watch-header.png')}}" alt="Product Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="product-img">
                            <img src="{{asset('asset/img/watch-features.png')}}" alt="Product Image">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="product-feature">
        ...
        <div id="products">
            <div class="container">
               ...
               <a href="{{route('show-product',$d->id)}}">
                ...
                <div class="mt-5 text-center"><a href="{{route('show-all-product')}}" class="btn btn-primary">show more</a></div>
                ...
                <div class="owl-carousel testimonials-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="{{asset('asset/img/testimonial-1.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="{{asset('asset/img/testimonial-3.jpg')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                            <h3>Tom McKenzie</h3>
                            <h4>Videographer</h4>
                    ...
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="{{asset('asset/img/testimonial-5.jpg')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                            <h3>Leo Conway</h3>
